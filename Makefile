...
all: pdf
pdf: clean cleanpdf allextra allimages epsc
...
cmdclean = rm -vf .*swp *.autosave *.pws *.bak *.aux *.def *.drv *.dvi *.glo *.idx *.log *.lot *.lof *.prv *.toc *~ *.out *.ilg *.ind *.glo *.ist *.gls *.bbl
cleanpdf:
	$(cmdcleanpdf)
...
distclean: clean cleanimages cleanpdf cleanextra
