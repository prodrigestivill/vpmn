...
\RequirePackage{url}
\ifpdf
  \RequirePackage[pdftex,pdfpagemode=UseOutlines,pdfpagelayout=TwoColumnRight,pdfstartview=XYZ]{hyperref}
\else
  \RequirePackage[dvips,pdfpagemode=UseOutlines,pdfpagelayout=TwoColumnRight,pdfstartview=XYZ]{hyperref}\fi
\AtBeginDocument{%
    \hypersetup{%
      breaklinks,
      pdfborder     = 0 0 0,
...
% Permet crear glosaris
\usepackage[hypertoc=true,hyper=false]{glossary}
\makeglossary
