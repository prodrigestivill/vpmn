...
Per tant la opció de crear un protocol de seguretat propi queda descartada i s'escull l'utilització d'un protocol existent i segur com el DTLS, amb el valor afegit de ser un protocol estàndard.
