...
\begin{itemize}
\item \textbf{Driver TAP} simula una targeta de xarxa Ethernet i treballa amb trames de capa 2 del \okeyword{model OSI}.
\item \textbf{Driver TUN} simula una targeta de xarxa punt-a-punt i treballa amb trames de capa 3 del model OSI.
\end{itemize}
