...
Per acabar la secció, i com a curiositat, a l'annex \refannexmail{} hi ha una conversa d'e-mails explicant què passa quan dins d'una VPN s'encapsula una connexió ja encriptada externament, per exemple una connexió \keyword{HTTPS}{Hypertext Transfer Protocol over SSL}. Per tal de que sigui significatiu han de coincidir múltiples factors i tampoc no hi ha cap implementació que ho tingui en compte, així que no es tindrà en compte en aquest programari.
