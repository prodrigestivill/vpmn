...
Els routers NAT s'utilitzen generalment per compartir una mateixa IP entre màquines diferents. El router guarda cada connexió en memòria per tal de reutilitzar els mateixos paràmetres en travessar més dades per la connexió. Tots els routers NAT assignen un temps de vida a la informació guardada en memòria i el renoven a mesura que circulen dades de la connexió. En el moment que caduca el temps de vida, la connexió es perd sense que cap dels participants s'en adonin, és per això que es important assegurar-se de que el router no arribi a esgotar aquest temps de vida.
