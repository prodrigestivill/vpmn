...
\begin{figure}[htb]
\centering
\includegraphics[width=\textwidth]{images/dia-case}
...
Com aclariment, seguidament s'explica un exemple del primer pas del procediment anterior (aconseguir el certificat firmat per la CA):
\begin{enumerate}
