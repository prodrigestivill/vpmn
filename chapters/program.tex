...
\end{center}
\end{table}
Tal com es veu en la taula \ref{T:inpkt}, aquests tenen un format que està inspirat en els 4 primers bytes de la capçalera IP, es poden diferenciar per el primer byte que en IP defineix la versió del protocol i la longitud de les capçaleres (HLen). El camp equivalent al que en IP està destinat a \keyword{ToS}{Type of Service} en els paquets de senyalització servirà per definir el tipus de paquet intern.
