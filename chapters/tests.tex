...
%TincVPN no intercanvia els certificats pq ja ho tenen fet. $830\cdot2=1660$
...
\end{center}
\end{table}
%netperf per TCP i UDP
%Comentar compressio
%Comentar que OpenSSL nomes pot treballar amb un thread per connexio a la vegada
%Comentar els fallos a la hora de fer els tests
\begin{table}[htb]
\begin{center}
